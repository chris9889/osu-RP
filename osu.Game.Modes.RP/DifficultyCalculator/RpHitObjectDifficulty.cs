...
namespace osu.Game.Modes.RP.DifficultyCalculator
{
    class RpHitObjectDifficulty
    {
        ...
        internal RpHitObjectDifficulty(BaseRpObject baseHitObject)
        {
            ...
            RpLongTailObject slider = BaseHitObject as RpLongTailObject;
            if (slider != null)
        ...
        private void calculateSpecificStrain(RpHitObjectDifficulty previousHitObject, RpDifficultyCalculator.DifficultyType type, double timeRate)
        {
            ...
            if (BaseHitObject.ObjectType == ObjectType.Container)
            {
                // Do nothing for spinners
            }
            else if (BaseHitObject.ObjectType == ObjectType.LongTail)
            {
                switch (type)
                {
                    case RpDifficultyCalculator.DifficultyType.Speed:
            ...
            else if (BaseHitObject.ObjectType == ObjectType.Click)
            {
