...
using osu.Game.Modes.RP.UI.GamePlay.Playfield.Layout.HitObjects.Drawables.Component.HitObject.Common.ShapePiece;
using OpenTK;

namespace osu.Game.Modes.RP.UI.GamePlay.Playfield.Layout.HitObjects.Drawables.Component.HitObject.MovePiece.Flow
{
    internal class ClickMoveFlow : BaseMoveFlow, IComponentSliderProgress
    {
        ...
        public ClickMoveFlow(BaseRpHitObject baseHitObject)
            : base(baseHitObject)
        {
